...
<form class="layui-form" style="width:80%;">
    <#--设置营销机会id的隐藏域，用于修改数据时，文本框中显示出默认的值-->
    <input name="id" type="hidden" value="${(saleChance.id)!}"/>
    <#--设置指派人的隐藏域,这里起判断作用，可不用name属性-->
    <input name="man" type="hidden" id="assignManId" value="${(saleChance.assignMan)!}"/>
    <div class="layui-form-item layui-row layui-col-xs12">
        <label class="layui-form-label">客户名称<span style="color: red">*</span></label>
        <div class="layui-input-block">
            <input type="text" class="layui-input"
                   <#--value="${(saleChance.customerName)!} 加感叹号防止报空-->
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input"
                    name="cgjl" value="${(saleChance.cgjl)!}" placeholder="请输入成功几率(数字)">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
