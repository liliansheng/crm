layui.use(['table','layer',"form"],function(){
    ...
    //绑定行工具栏  customerLosses：数据表格的lay-filter
    ...
    function openCustomerReprDialog(title,customerLossId) {
        layui.layer.open({
            title:title,
            type:2,
            area:["700px","500px"],
            maxmin:true,
            content:ctx+"/customer_loss/toCustomerLossPage?customerLossId="+customerLossId
        })
    }
